...
?>
    ...
    <section class="seccion contenedor">
        ...
        <div class="contenedor-anuncios">
            ...
            <div class="anuncio">
                ...
                <div class="contenido-anuncio">
                    <h3>Casa con Psicina</h3>
                    <p>Casa con psicina y acabados de lujo en la ciudad</p>
                    <p class="precio">$3,000</p>
    ...
    <section class="imagen-contacto">
        ...
        <p>Llena el formulario de contacto y un asesor se pondrá contigo en brevedad</p>
            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    <a href="entrada.php">
                        ...
                        <p class="informacion-meta">Escrito el: <span> 27/07/2025</span> por: <span> Admin</span></p>
                        <p>
            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    <a href="entrada.php">
                        ...
                        <p class="informacion-meta">Escrito el: <span> 27/07/2025</span> por: <span> Admin</span></p>
                        <p>
                            Consejos para decorar tu hogar con esta guía, aprende a combinar muebles y colores para darle vida a tu espacio
                        </p>
                    </a>
                </div>
